                ...
                <nav className="mx-auto flex max-w-7xl items-center justify-between p-6 lg:px-8" aria-label="Global">
                    <div className="flex lg:flex-1">
                        <a href="#" className="-m-1.5 p-1.5">
                            ...
                            <img className="h-8 w-auto" src="https://avatars.githubusercontent.com/u/147334352?s=48&v=4" alt="" />
                        </a>
                    </div>
                    <div className="hidden lg:flex lg:gap-x-12">
                        <div className="relative">
                            {/* <Popover>
                                <PopoverButton className="outline-none">
                                    <button type="button" className="flex items-center gap-x-1 text-sm font-semibold leading-6 text-gray-900 hover:text-sky-700" aria-expanded="false">
                                        Product
                        ...
                        {/* <a href="#" className="text-sm font-semibold leading-6 text-gray-900 hover:text-sky-700">Features</a>
                        <a href="#" className="text-sm font-semibold leading-6 text-gray-900 hover:text-sky-700">Marketplace</a>
                        <a href="#" className="text-sm font-semibold leading-6 text-gray-900 hover:text-sky-700">Company</a> */}
                    </div>
